...
export function AuthCard({ title, subtitle, children }: AuthCardProps) {
  return (
    <div className="fade-up relative w-full max-w-lg overflow-hidden rounded-[2rem] border border-line bg-surface-sub p-8 shadow-[0_30px_100px_-30px_rgba(0,0,0,0.9)] backdrop-blur-xl sm:p-10">
      <div
      ...
      />
      <div
        className="pointer-events-none absolute inset-x-24 bottom-0 h-px bg-gradient-to-r from-transparent via-line to-transparent"
        aria-hidden="true"
      />
      ...
      <h1 className="mt-2 text-center text-2xl font-black tracking-tight text-ink sm:text-3xl">
        {title}
      </h1>
      ...
      <div
        className="my-6 h-px bg-gradient-to-r from-transparent via-line to-transparent"
        aria-hidden="true"
      />
