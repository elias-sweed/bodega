export function DashboardSkeleton() {
  return (
    <div className="flex flex-col gap-6" aria-label="Cargando resumen" aria-busy="true">
      {/* Hero */}
      <section className="relative overflow-hidden rounded-[28px] border border-white/20 bg-white/10 p-8 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] backdrop-blur-2xl">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        {[0, 1].map((i) => (
          <section
            key={i}
            className="rounded-[28px] border border-white/15 bg-white/10 p-6 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.55)] backdrop-blur-2xl"
          >
      ...
      {/* Lista */}
      <section className="rounded-[28px] border border-white/15 bg-white/10 p-6 backdrop-blur-2xl">
        ...
        <div className="mt-5 flex flex-col gap-3">
          {[0, 1, 2].map((i) => (
            <div
              key={i}
              className="flex items-center justify-between gap-4 rounded-2xl border border-white/10 bg-white/10 p-4"
            >
