            ...
            <li key={venta.id} className="overflow-hidden rounded-[28px] border border-line bg-surface shadow-sm backdrop-blur-2xl">
              ...
              >
                  ...
                  <span className="flex flex-wrap items-center gap-x-2 gap-y-1 pl-0.5 text-xs font-semibold text-muted">
                    ...
                    <span
                      className={`rounded-full px-2 py-px text-[11px] font-bold backdrop-blur-xl ${
                        METODO_BADGES[venta.metodo_pago] ?? 'border border-line bg-surface text-muted'
                      }`}
                    >
                ...
                <span className="flex shrink-0 items-center gap-3">
                  <span className="flex flex-col items-end gap-1">
                    <span className="text-xl font-black tracking-tighter tabular-nums text-ink">
              ...
              {expanded && (
                <div className="fade-in border-t border-line px-5 py-4">
                  {loadingDetail ? (
                    <p className="text-sm font-medium text-muted">Cargando detalle…</p>
                  ) : detail ? (
                    <div className="flex flex-col gap-3">
                      <ul className="flex flex-col gap-2">
                      ...
                      <div className="flex flex-col gap-2 rounded-2xl border border-line bg-surface p-4 text-sm backdrop-blur-xl">
                        <div className="flex items-center justify-between gap-4">
                          <span className="font-medium text-muted">Lo vendió</span>
                          <span className="truncate font-bold text-ink">
                            {venta.creado_por ?? '—'}
                          </span>
                        </div>
                        <div className="flex items-center justify-between gap-4">
                          <span className="font-medium text-muted">El cliente pagó en total</span>
