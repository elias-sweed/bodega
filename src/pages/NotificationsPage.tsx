...
export function NotificationsPage() {
  ...
  return (
    <div className="fade-in mx-auto flex h-full w-full max-w-4xl flex-col gap-6">
      <header className="flex shrink-0 items-center gap-4 rounded-[28px] border border-line bg-surface p-5 shadow-[0_20px_60px_-24px_rgba(0,0,0,0.6)] backdrop-blur-2xl">
        ...
        <div className="min-w-0">
          ...
          <h1 className="mt-0.5 text-2xl font-black tracking-tighter text-ink drop-shadow-[0_2px_14px_rgba(0,0,0,0.4)] sm:text-3xl">
            Notificaciones
          </h1>
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                  <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-2xl border border-sky-200/30 bg-gradient-to-br from-sky-400/90 to-sky-600/90 px-4 py-2.5 text-sm font-black text-ink shadow-[0_14px_36px_-14px_rgba(56,189,248,0.8)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:brightness-110 active:translate-y-0 active:scale-95"
                  >
